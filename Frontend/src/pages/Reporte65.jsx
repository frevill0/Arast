...
const Reporte65 = () => {
    ...
    const handleSubmit = async (fechaInicio, fechaFin) => {
        try {
            ...
            const response = await axios.post(
                `${import.meta.env.VITE_BACKEND_URL}/reporte/socios65`,
    ...
    const generarPDF = async () => {
        ...
        doc.setFontSize(12);
        doc.text('Reporte de Socios que cumplen 65 años', 105, 22, { align: 'center' });
        
        if (reporte.length > 0) {
            doc.autoTable({
                startY: 40,
                head: [['Membresía', 'Socio', 'Fecha Nacimiento', 'Categoría', 'Estado', 'Edad', 'Fecha Cumple 65']],
        ...
        doc.save('reporte_socios_65.pdf');
    };
    ...
    return (
        <>
            <div>
                ...
                <hr className='my-4' />
                <p className='mb-8'>Este módulo te permite generar el reporte de socios que cumplen 65 años</p>
            </div>

            <FormularioFechas 
                titulo="Reporte de Socios que cumplen 65 años"
                        ...
                        <table className="min-w-full bg-white border border-gray-300">
                            <thead className="bg-customBlue text-white">
                                <tr>
                                    ...
                                    <th className="border border-gray-300 px-4 py-2">Fecha Cumple 65</th>
                                </tr>
                            </thead>
                            <tbody>
                                {reporte.map((socio, index) => (
                                    <tr key={index} className="odd:bg-gray-100 even:bg-gray-50">
                                        ...
                                        <td className="border border-gray-300 px-4 py-2 text-center">{socio.FechaCumple65}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
